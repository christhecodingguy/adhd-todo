...
describe('ToDoForm Component', () => {
    ...
    test('renders all to-do items correctly', () => {
        const toDoItems = [
            {
                item1: { itemName: 'Task 1', completed: false },
                item2: { itemName: 'Task 2', completed: false },
                miniBoss: { itemName: 'Mini Boss 1', completed: false }
            },
            {
                item1: { itemName: 'Task 3', completed: false },
                item2: { itemName: 'Task 4', completed: false },
                miniBoss: { itemName: 'Mini Boss 2', completed: false }
            },
            { boss: { itemName: 'Final Boss', completed: false } }
        ];
    ...
    test('does not render level 2 form when level 1 item values are empty', () => {
        const toDoItems = [
            {
                item1: { itemName: '', completed: false },
                item2: { itemName: '', completed: false },
                miniBoss: { itemName: '', completed: false }
            },
            {
                item1: { itemName: '', completed: false },
                item2: { itemName: '', completed: false },
            ...
            { boss: { itemName: '', completed: false } }
        ];
        const { queryByText } = render(<ToDoForm toDoItems={toDoItems} setToDoItems={mockSetToDoItems} formDirtyState={{ isDirty: false }} />);
    ...
    test('item 2 checkbox is disabled when item name is empty', () => {
        ...
        const { getByTestId } = render(<ToDoForm toDoItems={toDoItems} setToDoItems={mockSetToDoItems} formDirtyState={{ isDirty: false }} />);
    ...
    test('mini boss checkbox is enabled when level items are completed', () => {
        const toDoItems = [
            {
                item1: { itemName: 'Task 1', completed: true },
                item2: { itemName: 'Task 2', completed: true },
                miniBoss: { itemName: 'Mini Boss 1', completed: false },
            },
            {
                item1: { itemName: '', completed: false },
    ...
    test('boss task is disabled when mini bosses are not completed', () => {
        const toDoItems = [
            ...
            {
                item1: { itemName: 'Task 3', completed: true },
                item2: { itemName: 'Task 4', completed: true },
                miniBoss: { itemName: 'Mini Boss 2', completed: false }
            },
            { boss: { itemName: 'Final Boss', completed: false } }
        ];
        ...
        const toDoItems = [
            {
                item1: { itemName: 'Task 1', completed: true },
                item2: { itemName: 'Task 2', completed: true },
                miniBoss: { itemName: 'Mini Boss 1', completed: true },
            },
            {
                item1: { itemName: '', completed: false },
                item2: { itemName: '', completed: false },
    ...
    test('boss task is enabled when mini bosses are completed', () => {
        const toDoItems = [
            ...
            },
            {
                item1: { itemName: 'Task 3', completed: true },
                item2: { itemName: 'Task 4', completed: true },
                miniBoss: { itemName: 'Mini Boss 2', completed: true }
            },
            { boss: { itemName: 'Final Boss', completed: false } }
        ];
        const { getByTestId } = render(<ToDoForm toDoItems={toDoItems} setToDoItems={mockSetToDoItems} formDirtyState={{ isDirty: false }} />);
